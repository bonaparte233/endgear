...
const EQUIPMENT_NAME_EN_BY_ZH: Record<string, string> = {
  ...
  动火用隔温板: "Hot Work Insulation Slab",
  动火用护手: "Hot Work Hands PPE",
  生物辅助重甲: "LYNX Heavy Armor",
  生物辅助胸甲: "LYNX Cuirass",
  "生物辅助胸甲·壹型": "LYNX Cuirass T1",
  生物辅助臂甲: "LYNX Gloves",
  ...
  长息加固板: "Eternal Xiranite Bracing Slab",
  长息轻护甲: "Eternal Xiranite Light Armor",
  "长息轻护甲·壹型": "Eternal Xiranite Light Armor T1",
  长息裹手: "Eternal Xiranite Wraps",
  长息手套: "Eternal Xiranite Hands",
